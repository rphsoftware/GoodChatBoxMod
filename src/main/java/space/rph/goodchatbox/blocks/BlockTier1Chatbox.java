...
import space.rph.goodchatbox.tileentity.TileChatboxT1;
import space.rph.goodchatbox.tileentity.TileEntityChatbox;

public class BlockTier1Chatbox extends BlockContainer {
    public BlockTier1Chatbox() {
        super(Material.iron);
        setHardness(2F);
        setResistance(10F);
        setBlockName("chatboxt1");
    }

    @Override
    public TileEntity createNewTileEntity(World world, int metadata) {
        return new TileChatboxT1();
    }
